const registrationSuccess = (url) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <head style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
      ...
      <title style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">Frame</title>
      <!--[if mso]>
                <style>
                    * {
                  ...
                  <tbody>
                                ...
                                <table align="center" cellspacing="0" cellpadding="0" border="0"
                                  ...
                                  <tbody>
                                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                      <td
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                                        <img src="${process.env.IMAGES_BUCKET}registrationSuccess.png" width="431" alt="" border="0"
                                          style="-ms-interpolation-mode:bicubic;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;height:auto;display:block;margin:auto">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                        <div
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-size:30px;height:30px;line-height:30px">
                        </div>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          ...
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:123px;padding-right:131px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#000;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;text-align:center">Por
                                    favor, hacé click en el botón de abajo para continuar<br
                                      style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">con
                                    tu registro desde la app.</span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:122px;padding-right:131px;vertical-align:top">
                              ...
                              <td
                                ...
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                  <!--[if mso]>
                                                    ...
                                                    <w:anchorlock/>
                                                    <center style="white-space: nowrap; display:inline-block;color:#ffffff;font-family:Lato, Helvetica, Arial, sans-serif; font-size:16px;text-align:center;font-weight: 700;">Continuar con tu registro</center>
                                                    </v:roundrect>
                                                    <![endif]--> <a href="${url}"
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:none;background-color:#006cff;border-radius:10px;color:#fff;display:inline-block;font-family:Lato,Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;line-height:51px;mso-hide:all;text-align:center;text-decoration:none;white-space:nowrap;width:100%">Continuar
                                    con tu registro</a>
                                </div>
                              </td>
                            </tr>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                        <div
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-size:20px;height:20px;line-height:20px">
                        </div>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:200px;padding-right:208px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#000;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;text-align:center"><a href="${url}">${url}</a></span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <td
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          ...
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:87px;padding-right:93px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    ...
                                    tenés dudas sobre el contenido de este mail,<br
                                      style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">contactanos
                                    para que podamos ayudarte, haciendo </span><span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#025ed7;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;text-align:center"><a
                                      ...
                                      href="mailto:${process.env.SUPPORT}">click aquí</a></span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                                                                      ...
                                                                      <td
                                                                        ...
                                                                        <a href="${process.env.FACEBOOK}"
                                                                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;text-decoration:none"><img
                                                                            src="${process.env.IMAGES_BUCKET}facebook.png" width="24"
                                                                            alt="" border="0"
                                                                    ...
                                                                    <tr
                                                                      ...
                                                                      <td
                                                                        ...
                                                                        <a href="${process.env.INSTAGRAM}"
                                                                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;text-decoration:none"><img
                                                                            src="${process.env.IMAGES_BUCKET}instagram.png" width="25"
                                                                            alt="" border="0"
