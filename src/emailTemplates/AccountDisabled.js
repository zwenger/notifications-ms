...
const accoundDisabled = (date_next_attempt, time_next_attempt) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <head style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
      ...
      <title style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">email Cuenta deshabilitada</title>
      <!--[if mso]>
      <style>
          * {
                  ...
                  <tbody>
                      ...
                      <td
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          ...
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td class="eh"
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;height:39px;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:98px;padding-right:89px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#38475d;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:34px;font-weight:700;text-align:center">Se
                                    deshabilitó tu cuenta</span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <td
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          ...
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:107px;padding-right:120px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    ...
                                    te informamos que tu cuenta ha sido deshabilitada debido
                                    a múltiples intentos de inicio de sesión
                                    fallídos.</span>
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                ...
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#025ed7;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;text-align:center">Podrás
                                    intentar nuevamente el ${date_next_attempt} a las ${time_next_attempt} hs.</span>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                        <div
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-size:34px;height:34px;line-height:34px">
                           </div>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                ...
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#000;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;text-align:center">Tené
                                    en cuenta que si acumulas 4 deshabilitaciones tu cuenta
                                    será bloqueda.</span> 
                                </div>
                              </td>
                            </tr>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                        <div
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-size:29px;height:29px;line-height:29px">
                           </div>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                          <tbody>
                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                              <td
                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:94px;padding-right:86px;text-align:center;vertical-align:top">
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                  <span
