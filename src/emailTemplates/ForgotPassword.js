const forgotPassword = (token, url) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <head style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
      ...
      <title style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">Recupero de contraseña / olvidé
        contraseña</title>
      <!--[if mso]>
                <style>
                    * {
                  ...
                  <tbody>
                                            ...
                                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                              <td
                                                ...
                                                <div
                                                  ...
                                                  <span
                                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#025ed7;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:34px;font-weight:700;text-align:center">Cambiar
                                                    contraseña</span></div>
                                              </td>
                                            </tr>
                                          </tbody>
                                            ...
                                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                              <td
                                                ...
                                                <div
                                                  style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                                  <span
                                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#000;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:13px;text-align:center">Parece
                                                    que solicitaste cambiar tu contraseña vinculada a tu cuenta de Tach.<br
                                                      style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">Para
                                                    confirmar tu solicitud, utilizá el siguiente<br
                                                      style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">código
                                                    de 6 dígitos alfanuméricos a continuación:</span></div>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;vertical-align:top">
                        <div
                          style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-size:32px;height:32px;line-height:32px">
                           </div>
                      </td>
                    </tr>
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                            ...
                                            <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                              <td
                                                ...
                                                <div
                                                  style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:normal">
                                                  <span
                                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#38475d;font-family:Work Sans,Helvetica,Arial,sans-serif;font-size:34px;font-weight:700;text-align:center">${token}</span></div>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                    ...
                    <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                      <td
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0!important;mso-table-rspace:0!important;padding-left:126px;padding-right:127px;vertical-align:top">
                              ...
                              <td
                                ...
                                <div style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%">
                                  <!--[if mso]>
                                                    ...
                                                    <w:anchorlock/>
                                                    <center style="white-space: nowrap; display:inline-block;color:#ffffff;font-family:Lato, Helvetica, Arial, sans-serif; font-size:16px;text-align:center;font-weight: 700;">Cambia tu contraseña</center>
                                                    </v:roundrect>
                                                    <![endif]--> <a href=${url}
                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:none;background-color:#006cff;border-radius:10px;color:#fff;display:inline-block;font-family:Lato,Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;line-height:51px;mso-hide:all;text-align:center;text-decoration:none;white-space:nowrap;width:100%">Cambia tu Contraseña</a>
                                </div>
                              </td>
                            </tr>
                          </tbody>
